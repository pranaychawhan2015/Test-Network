...
function createOrg1() {
  ...
  set -x
  fabric-ca-client register --id.attrs 'Role=Doctor:ecert,Specialization=Orthopedics:ecert,Email=peer0.org1.example.com:ecert' --caname ca-org1 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Registering peer1"
  set -x
  fabric-ca-client register --id.attrs 'Role=Lab_Technician:ecert,Email=peer1.org1.example.com:ecert' --caname ca-org1 --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrg2() {
  ...
  infoln "Registering peer0"
  set -x
  fabric-ca-client register --id.attrs 'Role=Doctor:ecert,Specialization=Radiology:ecert,Email=peer0.org2.example.com:ecert' --caname ca-org2 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Registering peer1"
  set -x
  fabric-ca-client register --id.attrs 'Role=Doctor:ecert,Specialization=Obstetrics and Gynecology:ecert,Email=peer1.org2.example.com:ecert' --caname ca-org2 --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrg3() {
  ...
  infoln "Registering peer0"
  set -x
  fabric-ca-client register --id.attrs 'Role=Lab_Technician:ecert,Email=peer0.org3.example.com:ecert' --caname ca-org3 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/org3/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Registering peer1"
  set -x
  fabric-ca-client register --id.attrs 'Role=Doctor:ecert,Specialization=Dermatology:ecert,Email=peer1.org3.example.com:ecert' --caname ca-org3 --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/org3/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrg4() {
  ...
  infoln "Registering peer0"
  set -x
  fabric-ca-client register --id.attrs 'Role=Admin:ecert,Email=peer0.org4.example.com:ecert' --caname ca-org4 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Registering peer1"
  set -x
  fabric-ca-client register --id.attrs 'Role=Doctor:ecert,Specialization=Pediatrics:ecert,Email=peer1.org4.example.com:ecert' --caname ca-org4 --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/org4/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client register --id.attrs 'Role=Admin:ecert'  --caname ca-orderer --id.name orderer --id.secret ordererpw --id.type orderer --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
